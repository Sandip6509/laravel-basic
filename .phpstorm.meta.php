...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/laravel-basic/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./var/www/html/laravel-basic/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'livewire-tables.multiSelectDropdownFilter.defaultConfig','livewire-tables.events.enableUserForEvent','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'livewire.update','livewire.upload-file','livewire.preview-file','basic.create-first-project','basic.routing','livewire.submit-form-request','livewire.change-event',
'livewire.click-event','livewire.sweetalert','livewire.notification-demo','livewire.livewire-crud','livewire.dependant-dropdown',
'livewire.confirm-delete','livewire.wizard-form','storage.local',);
        registerArgumentsSet('views', 
'basic.create-first-project','basic.routing.index','home','layouts.app','livewire-learn.change-event',
'livewire-learn.click-event','livewire-learn.confirm-delete','livewire-learn.crud','livewire-learn.dependant-dropdown','livewire-learn.livewire-form',
'livewire-learn.notification-demo','livewire-learn.sweetalert','livewire-learn.wizard-form','livewire.change-event','livewire.click-event',
'livewire.confirm-delete','livewire.contact-form','livewire.notification-sweet-alert','livewire.notification-toastr','livewire.posts.create',
'livewire.posts.edit','livewire.posts.index','livewire.state-city-dropdown','livewire.wizard-form','laravel-exceptions-renderer::components.card',
