...
'livewire.update','livewire.upload-file','livewire.preview-file','basic.create-first-project','basic.routing','livewire.submit-form-request',
'livewire.change-event','livewire.click-event','livewire.sweetalert','livewire.notification-demo','livewire.livewire-crud',
'livewire.dependant-dropdown','livewire.confirm-delete','livewire.wizard-form','storage.local',);
